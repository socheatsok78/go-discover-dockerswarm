module dockerswarm_discover

go 1.23.8

replace github.com/socheatsok78/go-discover-dockerswarm => ../

require (
	github.com/hashicorp/go-discover v1.1.0
	github.com/socheatsok78/go-discover-dockerswarm v0.0.0-00010101000000-000000000000
)
